...
namespace dino::input {
    ...
    #define DEFINE_N64_BUTTON_INPUTS() \
        ...
        DEFINE_INPUT(Z, 0x2000, "Z Trigger") \
    ...
    enum class GameInput {
        ...
        N64_AXIS_START = Y_AXIS_POS,
        N64_AXIS_COUNT = X_AXIS_POS - N64_AXIS_START + 1,
    };
    #undef DEFINE_INPUT
    ...
    NLOHMANN_JSON_SERIALIZE_ENUM(dino::input::BackgroundInputMode, {
        {dino::input::BackgroundInputMode::On, "On"},
        {dino::input::BackgroundInputMode::Off, "Off"}
    });
